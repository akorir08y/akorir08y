<%-- 
    Document   : view_customer_transactions
    Created on : 11-Sep-2019, 13:28:32
    Author     : Keitany
--%>
...
<html>
    ...
    <body>
        ...
        <div class="alert alert-success" role="alert" style="text-align: center;">View Customer Payments</div>
        ...
        <form name="search_customer" style="margin:10px;padding:10px;float:right;">
           <div class="form-inline">
               <label for="Branch">Search Customer Payments:</label>

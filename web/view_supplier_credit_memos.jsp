<%-- 
    Document   : view_supplier_credit_memos
    Created on : 27-Nov-2019, 17:36:59
    Author     : Keitany
--%>
...
<html>
    <head>
        ...
        <title>View Supplier Credit Memos</title>
    </head>
    <body>
        <div id="content_provider">
        <div class="alert alert-success" role="alert" style="text-align: center;">View Supplier Credit Memos</div>
        ...
        <tr>
             ...
             <th scope="col">Credit Memo Description</th>

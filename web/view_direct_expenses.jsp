<%-- 
    Document   : view_direct_expenses
    Created on : 14-Dec-2019, 14:39:16
    Author     : Keitany
--%>
...
<html>
    <head>
        ...
        <title>View Direct Expenses</title>
    </head>
    <body>
        <div id="content_provider">
        <div class="alert alert-success" role="alert" style="text-align: center;">View Direct Expenses</div>
        ...
        <form name="search_customer" style="margin:10px;padding:10px;float:right;">
            <div class="form-inline">
                <label for="Branch">Search Direct Expenses:</label>
